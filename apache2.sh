...
# 기본 패키지 설치
echo "기본 패키지 설치"
sudo apt-get install -y zip unzip libpng-dev bind9-dnsutils apache2 librsvg2-bin fswatch openssl 1> /dev/null
...
sudo apt-get install -y --fix-missing php7.4-amqp php7.4-apcu php7.4-apcu-bc php7.4-ast php7.4-bcmath php7.4-bz2 php7.4-cli \
    ...
    php7.4-mbstring php7.4-zip php7.4-redis php7.4-imagick php7.4-xdebug libapache2-mod-php7.4 1> /dev/null
...
sudo apt-get install -y --fix-missing php8.1-amqp php8.1-apcu php8.1-bcmath php8.1-bz2 php8.1-cli php8.1-curl php8.1-dba \
    ...
    php8.1-xmlrpc php8.1-xsl php8.1-zip php8.1-xdebug php8.1-yaml libapache2-mod-php8.1 1> /dev/null
...
sudo apt-get install -y --fix-missing php8.2-amqp php8.2-apcu php8.2-bcmath php8.2-bz2 php8.2-cli php8.2-curl php8.2-dba \
    ...
    php8.2-xsl php8.2-zip php8.2-xdebug php8.2-yaml libapache2-mod-php8.2 1> /dev/null
...
sudo apt-get install -y --fix-missing php8.4-amqp php8.4-apcu php8.4-bcmath php8.4-bz2 php8.4-cli php8.4-curl php8.4-dba \
    ...
    php8.4-zip libapache2-mod-php8.2 1> /dev/null
...
sudo echo "zend_extension=xdebug.so" | sudo tee /etc/php/7.4/mods-available/xdebug.ini; \
...
sudo echo "xdebug.client_port = 9003" | sudo tee -a /etc/php/7.4/mods-available/xdebug.ini
sudo echo "xdebug.client_port = 9003" | sudo tee -a /etc/php/7.4/mods-available/xdebug.ini
sudo echo "xdebug.discover_client_host=yes" | sudo tee -a /etc/php/7.4/mods-available/xdebug.ini
...
sudo echo "zend_extension=xdebug.so" | sudo tee /etc/php/8.1/mods-available/xdebug.ini; \
...
sudo echo "xdebug.client_port = 9003" | sudo tee -a /etc/php/8.1/mods-available/xdebug.ini
sudo echo "xdebug.discover_client_host=yes" | sudo tee -a /etc/php/8.1/mods-available/xdebug.ini
...
sudo echo "zend_extension=xdebug.so" | sudo tee /etc/php/8.2/mods-available/xdebug.ini; \
...
sudo echo "xdebug.client_port = 9003" | sudo tee -a /etc/php/8.2/mods-available/xdebug.ini
sudo echo "xdebug.discover_client_host=yes" | sudo tee -a /etc/php/8.2/mods-available/xdebug.ini
...
sudo echo "zend_extension=xdebug.so" | sudo tee /etc/php/8.4/mods-available/xdebug.ini; \
...
sudo echo "xdebug.client_port = 9003" | sudo tee -a /etc/php/8.4/mods-available/xdebug.ini
sudo echo "xdebug.discover_client_host=yes" | sudo tee -a /etc/php/8.4/mods-available/xdebug.ini
