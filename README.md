...
* domains.docroot.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : docroot)
* domains.html.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : html)
* domains.public_html.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : public_html)
* domains.public.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : public)
* domains.web.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : web)
* domains.webroot.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : webroot)
* domains.www.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : www)
* domains.wwwroot.conf : 도매인 단위의 사이트 설정파일 (다큐먼트 루터 : wwwroot)
...
설정 파일은 아래와 같다. 아래의 내용은 다큐먼트 루터가 public인 경우이다. 나머지 파일은 다큐먼트 루터 부분만 드르다.
```
<VirtualHost *:80>
